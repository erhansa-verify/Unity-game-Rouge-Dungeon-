...
public class PlayerInventory : MonoBehaviour
{
    ...
    // Remove a weapon of a particular type, as specified by <data>.
    public bool Remove(WeaponData data, bool removeUpgradeAvailability = true)
    {
    ...
    // Remove a passive of a particular type, as specified by <data>.
    public bool Remove(PassiveData data, bool removeUpgradeAvailability = true)
    {
    ...
    public bool Remove(ItemData data, bool removeUpgradeAvailability = true)
    {
    ...
    // Find an empty slot and adds a weapon of a certain type, returns
    // the slot number that the otem was put in.
    ...
    public int Add(WeaponData data)
    {
        ...
        if (weaponType != null)
        {
            ...
            spawnedWeapon.transform.SetParent(transform); // Set the weapon to be a shild of the player.
        ...
        {
            Debug.LogWarning(string.Format("Invalid weapon type specified: {0}", data.name));
        }
    ...
    // Find an empty slot and adds a passive of a certain type, returns
    // the slot number that the otem was put in.
    ...
    public int Add(PassiveData data)
    {
        ...
        p.Initialize(data);
        p.transform.SetParent(transform); // Set the passive to be a shild of the player.
