...
/// <summary>
/// Replacement for the WeaponScriptableObject class. The idea we want to store all weapon evolution
/// data in one single object, intead of having multiple ScriptableObjects for each weapon level.
/// </summary>
...
public class WeaponData : ItemData
{
    ...
    // Gives us the stats growth / description of the next level.
